...
import nl.krashna.app.auth.SecurityConstants.EXPIRATION_TIME
...
class JWTAuthenticationFilter(private val jwtAuthenticationManager: AuthenticationManager) :
    ...
    override fun successfulAuthentication(
        ...
        val email = (auth.principal as org.springframework.security.core.userdetails.User).username
